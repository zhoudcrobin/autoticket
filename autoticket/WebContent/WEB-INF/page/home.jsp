    ...
    <body class="easyui-layout">
		<div data-options="region:'north',border:false" style="height:60px;">
			<table width="100%" cellSpacing=0 cellPadding=0>
        		<tr style="background:url('<c:url value="/comresource/image/topbg.gif"/>');">
        			<td width="50%" style="text-align: left;"><font style="FONT-SIZE: 40px;color:white">自动购票系统</font></td>
        			<td width="50%">
        				<table width="100%">
        					<tr>
		...
		<div data-options="region:'west',split:true,title:'功能菜单列表'" style="width:180px;padding:1px;overflow:hidden;">
			<div  class="easyui-accordion"  fit=true border="false">
				   <div title="订票业务" style="overflow:auto;">
	               	    <div class="nav-item">
	                         <a href="javascript:_home.addTab('余票查询','ticket/standby/index.do')">
